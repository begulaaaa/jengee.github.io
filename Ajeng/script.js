      ...
      Swal.fire("Awas aja kalo boong!!", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            title: `${nama} sayang ga sama ${Ammar}?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
              Swal.fire(`${Ammar} juga sayang banget sama ${Ajeng}`).then(function () {
                Swal.fire({
                  ...
                  val = e.value
                  Swal.fire(`Makasih ya udah sayang sama ${Ammar} ${val}%`).then(function () {
                    Swal.fire({
                      title: `Sekarang ${Ajeng} kangen ga sama ${Ammar}?`,
                      showDenyButton: true,
                      showCancelButton: false,
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Huhu iya ${Ammar} juga kangen ${Ajeng} :((`).then(function () {
              ...
              Swal.fire(`Yakin ga suka sama ${Ammar}?`, '', 'error').then(function () {
